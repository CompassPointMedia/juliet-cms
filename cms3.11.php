		...
		<div id="tab_editor" style="display:block;">
			...
			<div style="position:relative;float:right;margin-right:35px;">
				...
				<div id="optionsBox" style="display:none;">
					...
					<input type="hidden" value="0" name="Options[encryptEmails]" />
					<label><input name="Options[encryptEmails]" type="checkbox" id="Options[encryptEmails]" value="1" <?php echo $Options['encryptEmails'] || !isset($Options['encryptEmails']) ? 'checked': ''?> /> 
					Encrypt email-addresses (recommended)</label><br />
...
<br />
		...
		<div id="tab_settings" class="contentTab" style="display:none;">
			<input type="hidden" value="0" name="settings[CopySizedDownImages]" />
			...
			<input type="hidden" value="0" name="settings[RemoveMSWordMarkup]" />
			...
			Strip extra coding from Microsoft Word (recommended) (<a href="http://www.compasspointmedia.com/mediawiki-1.13.2/index.php?title=Microsoft_Word_Markup" target="help">help</a>)</label><br />
			<br />
			<br />
