...
<p>Welcome to <?php echo $adminCompany?>! This email confirms your application
			has been received.
<br /><br />
<?php echo $adminCompany?> staff will review your application in order to approve your account, and will send you another confirmation email once this is complete.  Once you are approved you will have access to our great <?php echo $usemod['wholesaleToken'] ? strtolower($usemod['memberWord']):''?> account features.
<br /><br />
