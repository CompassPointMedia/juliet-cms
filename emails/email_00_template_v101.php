<?php
/* ---------------------------------------------------------------- */
//2010-10-07: copied over from GiocosaCare emails; this is v1.01 with small revisions
...
<a href="<?php echo $usemod['usemodURLRoot'].'/login?src=switchboard';?>"><?php echo $usemod['usemodURLRoot'].'/login?src=switchboard';?></a>
<br /> 
<br />
...
<?php echo $usemod['usemodURLRoot'].'/login?UN='.$UserName.'&authKey='.md5($MASTER_PASSWORD.$PasswordMD5).'&src='.urlencode('switchboard');?> 
<br />
<br />
Sincerely,
