...
?><!-- #EndLibraryItem --><!-- InstanceEndEditable -->
    ...
    <h3>RelateBase Administrative Console    </h3>
    <p>&nbsp;</p>
    <p><strong><a href="mail/">Here is a link</a> to the mailer profiles feature</strong> </p>
    <p><strong><a href="list_labels.php">Here is a link</a> to the label print job feature</strong></p>
    <p>12/23/2012 - System Data Entry features available</p>
    <p>Only use this if you are familiar with PHP coding and MySQL - there is currently no documentation for this. <a href="root_systementry.php"><strong>click here to view</strong></a></p>
    <p>For accounting purposes, <a href="rfm_hub.php"><strong>reference the following new &quot;Hub Page&quot; here</strong></a>  </p>
	<!-- InstanceEndEditable -->
	<div class="cbsm"> </div>
  </div>
	<div id="footer">
