...
?><!-- #EndLibraryItem --><!-- InstanceEndEditable -->
	...
	<?php
	$datasetAddObjectJSFunction="ow('members.php','l1_ow','700,700',true)";
	if(isset($membersUseStatusFilterOptions))$useStatusFilterOptions=$membersUseStatusFilterOptions;
	if($test==17){
		require('components/comp_24_list_members_v300.php');
	}else{
		require('components/comp_24_list_members_v200.php');
	}
	?>

        <form name="formDeactivate" method="post" action="members_deactivate.php" target="w2"><input type="submit" value="Deactivate all users"></form>

        <form name="formActivate" method="post" action="members_activate.php" target="w2"><input type="submit" value="Activate all users"></form>
