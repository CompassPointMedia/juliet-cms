...
$addons=q("SELECT * FROM relatebase_rfm.rbase_addons WHERE Category='Console'", O_ARRAY, C_SUPER);
...
<div id="header"><!-- InstanceBeginEditable name="top_nav" -->
	<div id="headerBar1" style="padding:5px 10px 10px 12px; background-color:#CCC;">
		<h2>Add-Ons</h2>
	Select an add-on to be used on your console </div>
...
foreach($addons as $v){
	...
	<h2><a href="addons.php?cbFunction=refreshComponent&cbParam=fixed:addons&Addons_ID=<?php echo $v['ID']?>" title="Install this add-on into your console"><?php echo $v['Name']?></a></h2>
	<p>
