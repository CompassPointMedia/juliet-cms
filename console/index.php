...
<?php
if($settable_parameters['040']['proto_show_finan_20_in_console']){
	?>
	<h1>Beginning of Financial Module (Accounting Application)</h1>
	
	<a href="rfm_coa.php" onclick="return ow(this.href,'l1_coa','575,800');" title="Open and view/use the chart of accounts">Chart of accounts</a><br />

	<br />
	<a href="per_main.php">Additional Resources</a>
	<?php
}
?>
<!-- InstanceEndEditable -->
