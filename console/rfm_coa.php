...
<title>RelateBase Financial Module - Chart of Accounts</title>
<!-- InstanceEndEditable -->
...
<?php
ob_start();
if(!function_exists('coa'))require($_SERVER['DOCUMENT_ROOT'].'/functions/function_coa_v100.php');
coa();
$out=ob_get_contents();
ob_end_clean();
?>
<table class="coc1" width="100%" cellpadding="0" cellspacing="0">
<thead><tr>
<th>Name</th>
<th>Type</th>
</tr></thead><?php
