...
<?php 
	//this is taken from comp_24_list_members_v105.php as of 12/14/2009
	if($settable_parameters['051']['calMultipleCalendars'] && $test==17){
		require('components/comp_30_list_events_v110.php');
	}else{
		require('components/comp_30_list_events_v105.php'); 
	}
	?>
<!-- InstanceEndEditable -->
	<div class="cbsm"> </div>
