...
<div id="flightReviewQuestionnaire">
  <div id="page1">
		<div id="maininfo">
		  <h1 class="tac">Flight Review Questionnaire </h1>
		  <p>First Name: [input:firsname size=6 ] Middle Name: [input:middlename size=6 ] Last Name: [input:lastname size=6 ] <br />
	      Date: [input:date size=6] License: [input:license size=6 ] Ratings: [input:ratings size=9 ] Ratings: [input:ratings2 size=9] Flight Review Expiration Date: [input:flightreviewexdate size=6 ] Class of Medical: [input:clasofmedical size=6 ] </p>
		</div>
			<ol>
				<li>
...
Review
must contain these maneuvers:<br /> 
[input:maneuver1 size=6 ]&nbsp;&nbsp;&nbsp; [input:maneuver2 size=6 ] &nbsp;&nbsp;&nbsp; [input:maneuver3 size=6 ]</li>
...
class within the previous [input:numberofdays size= 3 ] days.</li>
            ...
            is
            exceeded.            </li>
	          <li>Fuel reserves for VFR flight are: day [input:dayfuel size=6 ] night [input:nightfuel size=6 ]</li>
            ...
            [textarea:staticinstruments cols=60 rows=5 ] <br />
            Gyro instruments?<br />
            [textarea:gyroinstruments cols=50 rows=5]            </li>
            ...
            hand turns.</li>
	          ...
	          <li>You may not operate in<br /> 
              [textarea:areas cols=50 rows=5 ] <br />
              areas without permission of the controlling agency.</li>
	...
	<div id="page2">
      <ol start="24"> 
        ...
        <li>When operating below 1
          ...
          [input:cruise2 size=6 ]thousands plus 500 feet on a mag course of 180 through 359 degrees.</li>
        ...
        <li>What are the required documents that have to be on board for each flight
          ...
          <table border="0">
            <tr>
              <td>1. [input:aircraftdoc1 size=15 ] </td>
              <td>1.[input:pilotdoc1 size=15 ] </td>
            </tr>
            <tr>
              <td>2.[input:aircraftdoc2 size=15 ]</td>
              <td>2.[input:pilotdoc2 size=15 ] </td>
            </tr>
            <tr>
              <td>3.[input:aircraftdoc3 size=15 ]</td>
              <td>3.[input:pilotdoc3 size=15 ] </td>
            </tr>
            <tr>
              <td>4.[input:aircraftdoc4 size=15 ]</td>
              <td>4.[input:pilotdoc4 size=15 ]</td>
            </tr>
          </table>
          <br />
        </li>
        <li>What is the distress or mayday transponder code? [input:maydaycode size=6 ]</li>
        <li>When should you use carburetor heat
          (if installed in the aircraft)?[textarea:carburetoruse cols=60 rows=5 ] </li>
        ...
        <li>What is the &lsquo;Flight Watch&rsquo; frequency? [input:flightwatchfrequency size=6 ] </li>
        <li>What is the standard FSS frequency? [input:fss size=6] </li>
        <li>What is a &lsquo;TFR&rdquo;? [input:ftr size=6 ] </li>
        ...
        <li>What is the best glide speed of your plane?
          <br />
          Aircraft type: [input:glidespeed size=6 ]&nbsp;	            <br />
          Best Glide Speed: [input:bestglidespeed size=6 ] </li>
        <li>What is Va and why is it important? [textarea:va cols=60 rows=5 ] </li>
        <li>What is the airport beacon colors/pattern for a
          CIVILIAN
          airport? [textarea:civilianplane cols=60 rows=5 ]&nbsp;	            <br />
          MILITARY airport? <br />
          [textarea:militiaryplace cols=60 rows=5 ] </li>
