...
?><!-- #EndLibraryItem --><!-- InstanceEndEditable -->
	...
	?>
		...
		<h3><?php echo $adminClientName?> Manufacturers</h3>
		<a href="manufacturers.php" onclick="return ow(this.href, 'l1_manufacturers','700,700');" title="Click here to add a new manufacturer">add new manufacturer</a>
	<div class="cb">&nbsp;</div>
	<!-- InstanceEndEditable -->
	<div class="cbsm"> </div>
	</div>
