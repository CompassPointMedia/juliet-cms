...
<title><?php echo h($adminCompany);?> List Items</title>
<!-- InstanceEndEditable -->
...
<strong><a href="report_items_changeable.php" onclick="return ow(this.href,'l1_quickitem','850,650');">Quick Item Updater I</a></strong> - <span class="gray">Added 12/2/2012 - edit multiple product data at once</span><br />

<?php
ob_start(); #begin buffer to move iframes
?>
<?php 
require($CONSOLE_ROOT.'/components/comp_11_itemslist_v200.php');
?>
