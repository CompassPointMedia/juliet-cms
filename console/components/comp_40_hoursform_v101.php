...
$(function(){
	$("#Employee_ID").change(function(){
		var html=$.post('resources/bais_01_exe.php', {mode: "listWeekHours", Employee_ID: $("#Employee_ID").val(), suppressPrintEnv :true, week: $("#StartTimeDay").val()}, function(data){$("#weekHours").html(data);});
	})
});
</script>
<?php
...
<input name="StartTimeDay" type="text" id="StartTimeDay" value="<?php echo $StartTimeDay ? $StartTimeDay : date('m/d/Y');?>" onchange="dChge(this);" />
<br />
Time started: 
<input name="StartTimeHour" type="text" id="StartTimeHour" value="<?php echo $StartTimeHour ? $StartTimeHour : date('g:iA');?>" size="12" onchange="dChge(this);" />
<br />
Time completed:
<input name="EndTimeHour" type="text" id="EndTimeHour" value="<?php echo $EndTimeHour ? $EndTimeHour : date('g:iA');?>" size="12" onchange="dChge(this);" /> 
&nbsp;&nbsp;
<span>
<input name="TimerOn" type="checkbox" id="TimerOn" value="1" onclick="toggleTimer(this);" onchange="dChge(this);" />
Timer on </span><br />
Pay Rate (If left blank it will enter the normal rate based on the employee) :<br />
$<input name="PayRate" type="text" id="PayRate" value="<?php echo $PayAmount?>" size="12" onchange="dChge(this);" /><br />
Total:
...
<br />
What was done:<br />
<textarea name="Description" cols="55" rows="7" id="Description" onchange="dChge(this);"><?php echo h($Description);?></textarea><br />
Measurable Goals:<br />
