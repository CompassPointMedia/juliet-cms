<?php
/*
$helpData=<<<____crikey___
Here is how the cell output works:
so we can output a field or expression value, e.g. Lastname, OR CONCAT(LastName,' ',FirstName):
...
Email=>array(
	datatype=>'email' //this will by default pass to make_clickable_links
	format=>'noformat' //this will STOP passage to make_clickable_links or any other formatting
)
Formula Field Expressions
-------------------------
FullName=>array(
	fieldExpressionFunction=>"CONCAT(LastName,' ',FirstName)"
)
PHP Functions
-------------
FullName=>array(
	fieldExpressionFunction=>"member_cols('FullName')"
...
@eval('$orderBy="'.$availableCols[$datasetGroup][$modApType][$modApHandle]['scheme'][$sort]['orderBy'].'";');
