...
?>
<div id="r_<?php echo $file['ID']?>" class="albumObject" style="position:relative;"><div class="del" title="Remove this frame from the album" onmouseover="this.className='del hl';" onmouseout="this.className='del';" onclick="deleteObject(this);">x</div><div id="title_<?php echo $file['ID']?>" class="title" onmouseover="edit(this,1);" onmouseout="edit(this,0);"><div class="editor" style="display:none;" onmouseover="edith(this,1);" onmouseout="edith(this,0);" onclick="editi(this,'input','Title');">edit</div><div><?php echo $file['Title']?></div></div><div id="imgInset_<?php echo $file['ID']?>-testing" class="img" onclick="hm_cxlseq=2;showmenuie5(event);"><img 
	...
	/></div>
	<div id="desc_<?php echo $file['ID']?>" class="albdesc" onmouseover="edit(this,1);" onmouseout="edit(this,0);"><div class="editor" style="display:none;" onmouseover="edith(this,1);" onmouseout="edith(this,0);" onclick="editi(this,'textarea','Description');">edit</div><div><?php echo $file['Description']?></div></div>
	<div class="cb">&nbsp;</div>
</div>
