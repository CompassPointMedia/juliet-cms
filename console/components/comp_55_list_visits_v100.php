...
/*
2010-05-09:
* implemented the datasetPreContent, used the new images/i/s/{iconset name} images
* added with that iconset an "add" button
...
$datasetAddObjectJSFunction='ow(this.href,\'l1_members\',\'700,700\',true);'; //this is becaused opening an object is not well developed yet
